...
const {useContext: useContext$a,useMemo: useMemo$3} = await importShared('react');
const DEFAULT_BREAKPOINTS = ['xxl', 'xl', 'lg', 'md', 'sm', 'xs'];
const DEFAULT_MIN_BREAKPOINT = 'xs';
const ThemeContext = /*#__PURE__*/React$G.createContext({
  prefixes: {},
...
const {useCallback: useCallback$2,useRef: useRef$2} = React$D;
// Normalizes Transition callbacks when nodeRef is used.
const TransitionWrapper = /*#__PURE__*/React$D.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  return /*#__PURE__*/jsxRuntimeExports.jsx(Transition$1, {
    ...
    children(status, {
      ...innerProps,
      ref: attachRef
    }) : /*#__PURE__*/React$D.cloneElement(children, {
      ref: attachRef
    })
  });
});
...
const divWithClassName = (className => /*#__PURE__*/React$C.forwardRef((p, ref) => /*#__PURE__*/jsxRuntimeExports.jsx("div", {
  ...p,
  ref: ref,
...
const AlertHeading = /*#__PURE__*/React$B.forwardRef(({
  className,
  bsPrefix,
...
const Button$2 = /*#__PURE__*/React$A.forwardRef((_ref, ref) => {
  let {
      as: asProp,
      disabled
    } = _ref,
 ...
 */
const Anchor = /*#__PURE__*/React$z.forwardRef((_ref, ref) => {
  let {
      onKeyDown
    } = _ref,
...
const AlertLink = /*#__PURE__*/React$y.forwardRef(({
  className,
  bsPrefix,
...
const Fade = /*#__PURE__*/React$x.forwardRef(({
  className,
  children,
  transitionClasses = {},
  onEnter,
  ...
  return /*#__PURE__*/jsxRuntimeExports.jsx(TransitionWrapper$1, {
    ...
    children: (status, innerProps) => /*#__PURE__*/React$x.cloneElement(children, {
      ...innerProps,
...
const CloseButton = /*#__PURE__*/React$w.forwardRef(({
  className,
  variant,
...
const Alert = /*#__PURE__*/React$v.forwardRef((uncontrolledProps, ref) => {
  const {
    bsPrefix,
    show = true,
...
const Button = /*#__PURE__*/React$u.forwardRef(({
  as,
  bsPrefix,
  variant = 'primary',
  size,
...
const context$1 = /*#__PURE__*/React$t.createContext(null);
...
const SelectableContext = /*#__PURE__*/React$p.createContext(null);
...
const NavContext = /*#__PURE__*/React$o.createContext(null);
...
const context = /*#__PURE__*/React$n.createContext(null);
...
const {useContext: useContext$7,useMemo: useMemo$1} = await importShared('react');
...
const FloatingLabel = /*#__PURE__*/React$9.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
const Form = /*#__PURE__*/React$8.forwardRef(({
  className,
  validated,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'form',
...
const Spinner = /*#__PURE__*/React$1.forwardRef(({
  bsPrefix,
  variant,
  animation = 'border',
  size,
...
function UserComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$1, { className: "p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Nav$1, { variant: "tabs", activeKey: activeTab, onSelect: (k) => setActiveTab(k), children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1.Item, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1.Link, { eventKey: "login", children: "Login" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1.Item, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1.Link, { eventKey: "signup", children: "Sign Up" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1, { onSubmit: handleSubmit, className: "mt-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Username" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Form$1.Group, { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Form$1.Label, { children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Form$1.Control,
          {
            type: "password",
      ...
      authError && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert$1, { variant: "danger", children: authError }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button$1, { variant: "primary", type: "submit", disabled: isSubmitting, children: isSubmitting ? /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner$1, { as: "span", animation: "border", size: "sm", role: "status", "aria-hidden": "true" }) : activeTab === "login" ? "Login" : "Sign Up" })
    ] })
  ] });
}
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "App", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ApolloProvider, { client, children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserComponent, {}) }) });
}
